...
printf "\033[36m[  INFOS  ]\033[0m Step 1 - building the toolchain\n"
...
printf "\033[36m[  INFOS  ]\033[0m ready to build toolchain\n"

for line in `cat $dir_toolchain_config`
do
	build_file=$(echo $dir_toolchain/$line.sh)
	printf "\033[36m[  INFOS  ]\033[0m running %-30s" "$build_file"
